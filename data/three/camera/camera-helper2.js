...
function main() {
    ...
    const camera = new THREE.OrthographicCamera(innerWidth / -16, innerWidth / 16, innerHeight / 16, innerHeight / -16, -200, 1000);
    ...
    const gui = new GUI();
    gui.add(camera, 'left', -200, 200).onChange(updateCamera);
    gui.add(camera, 'right', -200, 200).onChange(updateCamera);
    gui.add(camera, 'top', -100, 100).onChange(updateCamera);
    gui.add(camera, 'bottom', -1, 100).onChange(updateCamera);
    gui.add(camera, 'near', 1, 100, 0.1).onChange(updateCamera);
    ...
    const camera2 = new THREE.OrthographicCamera(innerWidth / - 4, innerWidth / 4, innerHeight / 4, innerHeight / -4, -200, 1000);
    camera2.position.set(150, 120, 180);
