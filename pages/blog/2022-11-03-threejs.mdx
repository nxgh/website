import AddGeometryS5 from '../../data/three/fundamentals/add-geometry/s5.mdx'
...
在我们开始前，让我们试着让你了解一下一个 three.js 应用的整体结构。一个 three.js 应用需要创建很多对象
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s1.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s2.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s3.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s4.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s5.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s6.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s7.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s8.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s9.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s10.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s11.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s12.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s13.js
```
...
{/* 通过将 castShadow 属性设置为 true，THREE.js 的阴影功能被启用 */}
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s14.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s15.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s16.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s17.js
```
...
```js src/index.js
// from ../../data/three/fundamentals/add-geometry/s18.js
```
